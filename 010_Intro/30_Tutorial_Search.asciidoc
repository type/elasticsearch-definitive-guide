...
_and_ ``climbing'' _and_ that contains the entire _phrase_
``rock climbing.''
...
http://www.elasticsearch.org/guide/en/elasticsearch/guide/current/highlighting-intro.html[highlighting reference documentation].
